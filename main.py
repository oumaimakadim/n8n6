...
async def parse_pdf(file: UploadFile = File(...)):
    ...
    has_any_data = (pop_for_val is not None and pop_ag_val is not None and pop_abs_val is not None)
    
    if has_any_data:
        is_percentage_mode = (pop_for_is_pct or pop_ag_is_pct or pop_abs_is_pct)
        ...
        if is_percentage_mode:
            ...
            pop_ag_out = fmt(pop_ag_val, True)
            pop_abs_out = fmt(pop_abs_val, True)
